#!/usr/bin/env python3
"""Build Supra portal + Jul27−Dec26 live trade tracker page."""
...
DATA_FILE = ROOT / "jul27_dec26_trade_data.json"
...
<style>
:root{--bg:#0b0f17;--card:#131a26;--line:#243043;--ink:#e8eef7;--mut:#93a1b5;--acc:#39d98a;--warn:#ffb84a;--bad:#ff6b6b}
...
<div class="grid cols-2">
  <a class="card featured" href="trade_tracker.html">
    <h2>Jul27−Dec26 steepener · live P&amp;L</h2>
    <p>Long JUN27 / short JUZ26. Entry 23 Jun 2026 UK open. Daily Barchart mark &amp; regime attribution.</p>
...
<meta name="viewport" content="width=device-width, initial-scale=1, viewport-fit=cover"/>
<meta name="theme-color" content="#0b0f17"/>
<title>Jul27−Dec26 steepener · live tracker</title>
...
<body>
<div class="wrap">
<div class="nav"><a href="portal.html">← Portal</a> · <a id="noteLink" href="#">Market note</a></div>
<header>
  <div class="eyebrow">Supra Fund Management · live trade</div>
  <h1 id="title">Jul27−Dec26 SONIA steepener</h1>
...
<div class="grid two">
  <div class="card">
    <h2>Slope (bp)</h2>
    <div class="chartbox"><canvas id="slopeChart"></canvas></div>
  </div>
  <div class="card">
    <h2>Implied rates (%)</h2>
...
<div class="card">
  ...
  <div style="overflow:auto;max-height:320px">
    <table class="tbl" id="pathTbl"><thead><tr>
      <th>Date</th><th>Dec-26 %</th><th>Jul-27 %</th><th>Slope</th><th>Δ day</th><th>Cum £</th>
...
pills.innerHTML = '<span class="pill">Bank ' + D.bank_rate_pct + '%</span>'
...
document.getElementById('stats').innerHTML = [
  ...
  ['Δ slope', fmtBp(pnl.slope_bp), cls(pnl.slope_bp)],
  ['Entry slope', fmtBp(D.entry.slope_bp), 'neu'],
  ['Mark slope', fmtBp(D.mark.slope_bp), cls(D.mark.slope_bp - D.entry.slope_bp)],
...
new Chart(document.getElementById('rateChart'), {
  type:'line',
  data:{labels,datasets:[
    {label:'Jul-27',data:path.map(r=>r.long_rate),borderColor:'#39d98a'},
    {label:'Dec-26',data:path.map(r=>r.short_rate),borderColor:'#ffb84a'}
  ]},
  options:{responsive:true,maintainAspectRatio:false,plugins:{legend:{labels:{color:'#93a1b5'}}},scales:{x:{ticks:{color:'#93a1b5'}},y:{ticks:{color:'#93a1b5'}}}}
});
...
[...path].reverse().forEach(r=>{
  pt.innerHTML += '<tr><td>'+r.date+'</td><td class="num">'+r.short_rate.toFixed(3)+'</td><td class="num">'+r.long_rate.toFixed(3)+'</td><td class="num">'+r.slope_bp.toFixed(1)+'</td><td class="num">'+(r.daily_pnl_gbp!=null?fmtGbp(r.daily_pnl_gbp):'—')+'</td><td class="num">'+fmtGbp(r.cum_pnl_gbp)+'</td></tr>';
});

document.getElementById('foot').textContent =
  '1× JUN27 / 1× JUZ26 · £'+GBP+'/bp per leg-pair · Barchart EOD. Not investment advice.';
</script>
</body>
</html>
...
def main():
    for name, html in [
        ("docs/portal.html", PORTAL_HTML),
        ("docs/trade_tracker.html", TRACKER_HTML),
        ("portal.html", PORTAL_HTML),
        ("trade_tracker.html", TRACKER_HTML),
    ]:
        out = ROOT / name
