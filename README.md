...
**Permanent URL (static, auto-refreshed weekdays):**  
https://alilodhi-cloud.github.io/SOFR_FFR_basis/ff_30d_dashboard.html

Same UX as the ASX 30-day / 1M SONIA dashboards: frozen latest monthly strip (green), historical time-travel (amber), pin legs, FOMC meeting pricing (next-month contract as post-decision proxy), and daily Δ table. Policy anchor is the **live fed funds target range midpoint** from NY Fed EFFR.

```bash
python3 analyze_ff_30d.py
python3 build_ff_30d_dashboard.py
```
