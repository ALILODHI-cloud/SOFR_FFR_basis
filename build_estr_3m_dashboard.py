"""Build interactive 3M €STR curve dashboard (frozen reference + evolution overlay)."""
from __future__ import annotations

import json
from pathlib import Path

from analyze_estr_3m import compute_ecb_meeting_pricing_3m, rebuild_evolution_from_snapshot
...
(ROOT / "estr_3m_data.json").write_text(json.dumps(data, indent=2), encoding="utf-8")
...
<div class="wrap">
<header>
  <p style="margin:0 0 10px;font-size:13px"><a href="portal.html" style="color:#93a1b5;text-decoration:none">← Markets portal</a> · <a href="estr_1m_dashboard.html" style="color:#93a1b5;text-decoration:none">1M €STR</a></p>
  <h1>3M €STR curve · frozen reference + time travel</h1>
...
<div class="card">
  <h2>ECB Governing Council meeting pricing (from 3M €STR strip)</h2>
