"""Build interactive 1M ESTR curve dashboard (frozen reference + evolution overlay)."""
from __future__ import annotations

import json
from pathlib import Path

from analyze_estr_1m import compute_ecb_meeting_pricing
...
if "ecb_meeting_pricing" not in data:
    data["ecb_meeting_pricing"] = compute_ecb_meeting_pricing(
...
<title>1M ESTR Curve Live</title>
...
<header>
  ...
  <h1>1M ESTR curve · frozen reference + time travel</h1>
...
<div class="card">
  <h2>ECB Governing Council meeting pricing (from 1M ESTR strip)</h2>
...
for name in ("estr_1m_dashboard.html", "docs/estr_1m_dashboard.html"):
